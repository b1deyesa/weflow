<x-layout.admin>
    ...
    <x-form action="{{ route('admin.customer.store') }}" method="POST" class="mt-4">
        <div class="d-flex gap-3">
            <div class="d-flex flex-column" style="min-width: 70%">
                <div class="d-flex gap-3">
                    <div class="d-flex flex-column w-100">
                        <x-input label="Customer ID" type="text" name="code" value="{{ $code }}" disabled />
                ...
                <x-input label="Address" type="textarea" name="address" />
            </div>
            <x-input label="Note" type="textarea" name="note" rows="8" style="height: 210px" />
        </div>
            ...
            <x-slot:body>
                @foreach ($courses as $course)
                    <tr>
                        ...
                        <td width="1%">
                            <input type="checkbox" class="btn-check" name="course_id[{{ $course->id }}]" id="course-{{ $course->id }}" autocomplete="off">
